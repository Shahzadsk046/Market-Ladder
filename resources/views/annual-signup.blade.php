                ...
                <form action="/store"
                    ...
                    <div class="form-row justify-content-center p-0">
                        <div class="aboutHeader">
                            <h2 class="text-uppercase text-center">Annual Membership <a class="text-green"
                                   href="/join-now"
                                   style="font-size: x-small; font-family: 'Montserrat',sans-serif; text-transform: capitalize">&nbsp;
                                    Change ?</a></h2>
                        </div>
                        <div class="text list-unstyled">
                            <label class="pt-1 fw-semibold">Your card will be automatically billed at the end of every year
                                until you cancel. You may get a prorated refund of all full months remaining on your plan if
                                you decide to cancel your membership before the end of the paid period.</label>
                        </div>
                        <input type="text"
                               name="price_id"
                               id="price_id"
