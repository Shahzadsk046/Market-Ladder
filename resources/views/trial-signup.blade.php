    ...
    <section>
        <div class="row m-0 pt-5 fixedWidth text-dgrey bg-transparent">
            <div class="col-12">
                <form action="/store"
                      method="get"
                      class="col-sm-6 mx-auto pt-0 ps-4 pe-4 pb-4 text-ddgrey bg-transparent">
                    <div class="form-row justify-content-center p-0">
                        <div class="aboutHeader">
                            <h2 class="text-uppercase text-center">WELCOME TO YOUR 30 DAY TRIAL <a class="text-green"
                                   href="/join-now"
                                   style="font-size: x-small; font-family: 'Montserrat',sans-serif; text-transform: capitalize">&nbsp;
                                    Change ?</a></h2>
                        </div>
                        <div class="text list-unstyled">
                            <label class="pt-1 pb-2 fw-semibold">Please enter your credit card to initiate the 30 day free
                                trial. Just cancel your membership anytime before your 30 day trial ends and your card will
                                not be billed, and you will still get the full 30 day free trial.</label>
                            <label class="pt-1 pb-2 fw-semibold">If you’d like to continue with The Market Ladder, do
                                nothing and you’ll automatically roll over to the Monthly Membership Plan billed at current
                                pricing.</label>
                            <label class="pt-1 pb-2 fw-semibold">Your card will be automatically billed at the end of every
